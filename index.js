...
app.post('/person', function(req, res) {
  request.post('https://api.projectoxford.ai/face/v1.0/persongroups/' + PERSON_GROUP_ID + '/persons', {
    headers: {
      'Content-Type': 'application/json',
      'Ocp-Apim-Subscription-Key': API_KEY
    },
    json: {
      name: 'William Wettersten',
      userData: 'https://scontent-sea1-1.xx.fbcdn.net/hphotos-xfa1/v/t1.0-9/391584_4404273781433_1216832326_n.jpg?oh=4e7d0161491434586da2249bf5d5fcb8&oe=5770706B'
    }
